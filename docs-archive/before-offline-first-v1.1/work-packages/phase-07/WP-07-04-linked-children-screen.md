# WP-07-04 — Linked Children Screen

## Objective

Display the authenticated guardian's linked students.
...
Use the documented linked-children API and include loading, empty, error, and success states.
