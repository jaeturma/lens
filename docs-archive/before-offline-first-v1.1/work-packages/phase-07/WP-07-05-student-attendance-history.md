# WP-07-05 — Student Attendance History

## Objective

Display current attendance status and paginated history for a selected child.
...
Use the attendance API without duplicating attendance business rules in Flutter.
...
- History handles loading, empty, error, and pagination.
- Guardians cannot request unrelated students.
