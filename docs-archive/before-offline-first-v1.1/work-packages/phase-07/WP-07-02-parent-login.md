# WP-07-02 — Parent Login

## Objective

Build the parent or guardian login screen and connect it to the Laravel API.
...
Implement validation, loading, server errors, token storage, and authenticated routing.
