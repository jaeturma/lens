# WP-07-07 — Notification Inbox

## Objective

Build a notification inbox with unread count and mark-as-read behavior.
...
Implement list, pagination if required, details or payload navigation, and read state.
...
- Attendance and announcement notifications display.
