# WP-08-08 — Pilot Readiness Checklist

## Objective

Produce the final checklist for a limited school pilot.
...
Verify users, devices, cards, attendance rules, notifications, privacy, support, backup, and known limitations.
...
- Go or no-go criteria are clear.
