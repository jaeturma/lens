# WP-08-02 — API Authorization Tests

## Objective

Add focused authorization coverage for guardians, administrators, and RFID devices.
...
Test cross-student access, inactive users, revoked devices, and unauthorized admin actions.
