# WP-03-04 — Device Authentication and Security

## Objective

Secure RFID device requests independently from parent authentication.
...
Implement dedicated credentials, rotation or revocation, rate limits, timestamp tolerance, and secure logging.
...
- Rate limiting and validation are tested.
