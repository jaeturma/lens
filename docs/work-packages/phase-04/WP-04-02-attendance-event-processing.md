# WP-04-02 — Attendance Event Processing

## Objective

Convert valid raw scans into attendance events.
...
Implement a focused processor or action that is testable and does not place business logic in controllers.
...
- Every processed scan has a clear status.
- Attendance events reference their raw scans.
- Processing is transaction-safe.
